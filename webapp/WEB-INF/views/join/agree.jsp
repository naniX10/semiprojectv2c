...
<div>
    <h2>사이트 약관 동의</h2>
    <small class="text-muted">회원가입을 위해서 아래 사이트 이용약관&middot;개인정보 수집
            및 이름에 대한 안내를 읽고 동의해주세요</small>
</div><!-- 섹션 타이틀 -->
...
Copyright © Kakao Corp. All rights reserved.
                    ...
                    <div class="custom-control custom-checkbox text-right">
                        ...
                        <label for="agree1" class="custom-control-label text-danger">이용약관에 동의할까?</label>
                    </div>
                    </form>
                </div> <!-- 이용약관 -->

            <div class="card card-body bg-light">
                <h3>개인 정보 수집 및 이용에 대한 안내</h3>
                <form name="agree1frm" id="agree1frm">
                    <div class="form-group">
                        <textarea rows="10" class="form-control border-danger text-danger">
제1조 해달은 무적이고!
...
멍멍펀치! 멍멍펀치! 멍멍펀치! 멍멍펀치!
                    ...
                    <div class="custom-control custom-checkbox text-right">
                        ...
                        <label for="agree2" class="custom-control-label text-danger">개인정보 수집에 동의할까?</label>
                    </div>
                </form>
                </div> <!-- 개인정보 -->
...
<div class="card card-body bg-light">
    <div class="text-center">
        <button class="btn btn-success" id="okagree" type="button">모두 동의합니다</button>
        <button class="btn btn-danger" id="noagree" type="button">동의하지 않습니다</button>
    </div>
    </div><!-- 버튼 -->
