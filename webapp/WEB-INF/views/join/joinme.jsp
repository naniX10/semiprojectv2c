        ...
        <form name="joinfrm" id="joinfrm">
            <div class="row">
                <div class="col-11 offset-1">
                    ...
                    <div class="form-group row">
                        <label class="col-2 col-form-label text-danger text-right" for="jumin1">주민번호</label>
                    ...
                    <div class="form-group row">
                        ...
                        <span class="col-form-label">&nbsp;&nbsp;8~16자의 영문 대소문자, 숫자 및 특수문자를 사용할 수 있습니다</span>
                    </div><!-- 비밀번호 -->
                    ...
                    <div class="form-group row">
                        ...
                        <span class="col-form-label">&nbsp; &mdash; &nbsp; </span>
                        <input type="text" name="jumin2" id="jumin2" class="form-control border-danger col-1" readonly>
                        &nbsp;
                    ...
                    <div class="form-group row">
                        ...
                        <select class="form-control border-danger col-2" name="tel1" id="tel1">
                            <option>국번</option>
                            <option>010</option>
                            <option>011</option>
                            <option>017</option>
                    ...
                    <div class="form-group row">
                        <label class="col-2 col-form-label text-danger text-right">자동입력방지</label>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form name="zipfrm" id="zipfrm">
                            ...
                            <div class="form-group row">
                                <hr class="col-9">
                                <p class="col-12 text-danger text-center">지역의 읍/면/동의 이름을 공백없이 입력하신 후 [검색하기] 버튼을 눌러주세요</p>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger"><i class="fas fa-check-square"></i> 선택하고 닫기</button>
                    </div>
                </div>
            </div>
        </div>
